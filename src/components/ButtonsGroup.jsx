  ...
  return (
    <div className=" z-10 flex flex-col w-full px-3 mt-5 gap-5">
      ...
      >
        ...
        <h2>WhatsApp</h2>
        <div className="h-full opacity-70 w-[100px] flex justify-center items-center bg-[#823CFA] rounded-br-xl rounded-tr-xl">
      ...
      >
        <MoveRight color="#823CFA" className="ml-5 animate-slide-x" />
        <h2>Portfólio</h2>
        <div className="h-full w-[100px] opacity-70 flex justify-center items-center bg-[#823cfa] rounded-br-xl rounded-tr-xl">
